module github.com/dominant-strategies/mesh-quai

go 1.24

replace github.com/dominant-strategies/go-quai => ../go-quai

replace github.com/dominant-strategies/mesh-sdk-go => ../mesh-sdk-go

require (
	github.com/dominant-strategies/go-quai v0.43.2
	github.com/dominant-strategies/mesh-sdk-go v0.0.0-00010101000000-000000000000
